	...
	return (
		...
		>
			...
			<div className="absolute inset-0 bg-neutral-800">
				...
				<div className="-z-10 absolute inset-0 flex items-center justify-center bg-gradient-to-br from-neutral-700 to-neutral-900">
			...
			<div
				className={`-translate-x-1/2 -translate-y-1/2 absolute top-[40%] left-1/2 flex flex-col gap-1.5 transition-all duration-200 ${isHovered ? 'scale-100 opacity-100' : 'scale-90 opacity-0'}`}
				onClick={(e) => {
					e.preventDefault()
					e.stopPropagation()
				}}
