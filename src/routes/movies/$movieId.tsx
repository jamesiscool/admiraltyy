...
import { Bookmark, Film, Search, Settings2, Trash2 } from 'lucide-react'
...
import { deleteMovie, getMovieOptions, updateMovie } from '@/services/movies'
...
function MovieDetailPage() {
	...
	const { data: movie } = useSuspenseQuery(getMovieOptions(movieId))
