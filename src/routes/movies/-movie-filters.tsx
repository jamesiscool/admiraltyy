...
export type StatusFilter = 'all' | 'wanted' | 'downloaded'
export type MonitoredFilter = 'all' | 'monitored' | 'unmonitored'
export type SortOption = 'dateAdded' | 'title' | 'releaseDate' | 'year'
...
export function MovieFilters({
	...
	return (
		<div className="flex flex-wrap items-center gap-3">
			{/* Quick Filters - Status Toggle */}
			<ToggleGroup
				value={[statusFilter]}
				onValueChange={(values) => {
					const value = values[0] as StatusFilter | undefined
			...
			>
				...
				<ToggleGroupItem
					value="wanted"
					className="data-[pressed]:text-white data-[pressed]:[background-color:rgba(245,158,11,0.9)]"
				>
					Missing
				</ToggleGroupItem>
				<ToggleGroupItem
