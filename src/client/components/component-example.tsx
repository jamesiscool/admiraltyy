...
import { Example, ExampleWrapper } from '@/client/components/example'
import {
	AlertDialog,
	AlertDialogAction,
	AlertDialogCancel,
...
import { Card, CardAction, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@/client/components/ui/card'
import { Combobox, ComboboxContent, ComboboxEmpty, ComboboxInput, ComboboxItem, ComboboxList } from '@/client/components/ui/combobox'
import {
	DropdownMenu,
		...
		>
			<Card className="relative w-full max-w-sm overflow-hidden pt-0">
				...
				<img
					...
					// biome-ignore lint/a11y/noRedundantAlt: just a placeholder image
