...
function Field({ className, orientation = 'vertical', ...props }: React.ComponentProps<'div'> & VariantProps<typeof fieldVariants>) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: Need to leave this as a div for compatibility with the shadcn/ui library
		<div
			role="group"
			data-slot="field"
...
function FieldError({
	...
	const content = useMemo(() => {
		...
		// biome-ignore lint/suspicious/noArrayIndexKey: Index will not change during the lifetime of the component
